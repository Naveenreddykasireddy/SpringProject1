...
<form:label path="id">ADMIN ID:</form:label><br>
<form:input path="id"/>
<br><br>
<form:label path="name">ADMIN NAME:</form:label><br>
<form:input path="name"/>
<br><br>
<form:label path="email">ADMIN EMAIL:</form:label><br>
<form:input path="email"/>
<br><br>
<form:label path="password">ADMIN PASSWORD:</form:label><br>
